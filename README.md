...
flop_isomorphisms is a Python library for dealing with flop isomorphisms in relation to poker.
...
flop_isomorphisms.get_isomorphisms('2dAd2s')

# returns "Qs7s3h"
flop_isomorphisms.normalise_flop('7cQc3s')
```
